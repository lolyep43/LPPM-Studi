...
@section('title', 'Tambah Data Inovasi Industri - LPPM ITK')
...
<h1>Tambah Inovasi Industri</h1><br>
<div class="row">
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form class="" action="{{ route('inovasi-industri.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="position-relative form-group"><label>Thumbnail</label><input name="gambar" type="file" class="form-control-file"></div>
