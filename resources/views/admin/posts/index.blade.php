...
<div class="row">
    <div class="col-lg-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">
                    <a href="{{ route('post.create')}}" class="btn btn-success btn-sm">Tambah Berita</a>
                </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('post.destroy', $hasil->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <a href="{{ route('blog.isi', $hasil->slug)}}" class="btn btn-primary btn-sm" target="_blank">Lihat</a>
