...
@foreach($data as $isi_inovasi_mandiri)
@section('judul', $isi_inovasi_mandiri->judul. ' - LPPM ITK')
@endforeach
@section('isi')
		...
		<div class="row">
			<div class="col-md-12 col-lg-8">
				<div class="p-30 mb-30 card-view">
					@foreach($data as $isi_inovasi_mandiri)
					<img src="{{ asset($isi_inovasi_mandiri->gambar)}}" alt="">
					<h3 class="mt-30 mb-5"><a href="#"><b>{{$isi_inovasi_mandiri->judul}}</b></a></h3>
					<ul class="list-li-mr-10 color-lite-black">
						<li><i class="mr-5 font-12 ion-clock"></i>{{$isi_inovasi_mandiri->created_at->isoFormat('D MMMM YYYY')}}</li>
						<li><i class="mr-5 font-12 ion-android-person"></i>Admin</li>
					</ul><br>
					{!!$isi_inovasi_mandiri->konten!!}
				</div>
				@endforeach
			</div>
