...
@section('judul', 'Inovasi industri - LPPM ITK')
@section('isi')
		...
		<div class="row">
			<div class="col-md-12 col-lg-8">
				<div class="mb-30 p-30 ptb-lg-25 plr-sm-15 card-view">
					<h4 class="p-title"><b>Inovasi industri</b></h4>
					@foreach($data as $list_inovasi_industri)
					<div class="mb-30 sided-250x card-view">
						<div class="s-left">
							<a href="{{ route('inovasi-industri.isi', $list_inovasi_industri->slug)}}"><img src="{{$list_inovasi_industri->gambar}}" alt=""></a>
						</div>
						<div class="s-right ptb-50 plr-sm-20 pt-sm-20 pb-lg-5 plr-30 plr-xs-0">
							<h4><a href="{{ route('inovasi-industri.isi', $list_inovasi_industri->slug)}}">{{$list_inovasi_industri->judul}}</a></h4>
							<ul class="mtb-10 list-li-mr-20 color-lite-black">
								<li><i class="mr-5 font-12 ion-clock"></i>{{$list_inovasi_industri->created_at->isoFormat('D MMMM YYYY')}}</li>
			...
			<div class="col-md-12 col-lg-4">
                <x-search placeholder="cari judul ..."/>
