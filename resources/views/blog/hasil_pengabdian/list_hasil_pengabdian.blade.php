...
@section('judul', 'Hasil Pengabdian - LPPM ITK')
@section('isi')
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="mb-30 p-30 ptb-lg-25 plr-sm-15 card-view">
                    <h4 class="p-title"><b>HASIL PENGABDIAN</b></h4>
                    @foreach($data as $list_hasil_pengabdian)
                    <div class="mb-15 sided-250x card-view">
                        <div class="s-left">
                            <a href="{{ route('hasil-pengabdian.isi', $list_hasil_pengabdian->slug)}}"><img src="{{$list_hasil_pengabdian->foto}}"></a>
                        </div>
                        <div class="s-right ptb-25 plr-sm-20 pt-sm-20 pb-lg-5 plr-30 plr-xs-0">
                            <h4><a href="{{ route('hasil-pengabdian.isi', $list_hasil_pengabdian->slug)}}">{{$list_hasil_pengabdian->judul}}</a></h4>
                            <ul class="mtb-10 list-li-mr-20 color-lite-black">
                                <li><i class="mr-5 font-12 ion-android-person"></i>Ketua: {{$list_hasil_pengabdian->peneliti}}</li><br>
                                <li><i class="mr-5 font-12 ion-clock"></i>Tahun: {{$list_hasil_pengabdian->tahun}}</li>
                            </ul>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="col-md-12 col-lg-4">
                <x-search placeholder="cari pengabdian ..."/>
